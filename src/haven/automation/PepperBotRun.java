        ...
        if (harvest) {
            ...
            for (Gob g : crops) {
                ...
                if (PBotUtils.invFreeSlots(ui) < 4 && !stopThread) {
                    List<Gob> goblist = PBotUtils.getGobs(ui);
                    boilmode = true;
                    ...
                    while (PBotUtils.invFreeSlots(ui) < 4 && !stopThread) {
                        ...
                        if (vm.amount < 30) {
                            ...
                            if (barrel.ols.size() == 0 && water != null) {
                                ...
                                PBotUtils.sleep(1000);
                                ui.gui.map.wdgmsg("click", water.sc, water.rc.floor(posres), 3, 0, 0, (int) water.id, water.rc.floor(posres), 0, -1);
                                PBotUtils.sleep(3500);
                                ui.gui.map.wdgmsg("click", cauldron.sc, cauldron.rc.floor(posres), 3, 0, 0, (int) cauldron.id, cauldron.rc.floor(posres), 0, -1);
                                FlowerMenu.setNextSelection("Open");
                                PBotUtils.sleep(1000);
                                ui.gui.map.wdgmsg("click", Coord.z, retain, 3, 0);
                                PBotUtils.sleep(1000);
                                ui.gui.map.wdgmsg("click", cauldron.sc, cauldron.rc.floor(posres), 3, 0, 0, (int) cauldron.id, cauldron.rc.floor(posres), 0, -1);
                                FlowerMenu.setNextSelection("Open");
                                PBotUtils.sleep(1000);
